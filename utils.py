...
logger = logging.getLogger('metric_89_gs25')
...
def send_time_to_kafka(metric, box_id, camera_id, customer_id, infomation, bootstrap_servers="hcm.gateway01.cxview.ai:9094", topic="production-gatewayhn-peoplecount"):
    ...
    if metric == 9:
        data = {
            ...
            "checkout_to_exit_time": round(infomation,1),
            "timestamp": timestamp
        }
    elif metric == 8:
        data = {
            ...
            "metric": 8,
            "customer_id": customer_id,
            "queue_to_counter_time": round(infomation,1),
            "timestamp": timestamp
        }
    elif metric == 5:
        data = {
        ...
        "customer_id": customer_id,
        "zone_id" : camera_id,
        "dwell_ime_at_aisle": round(infomation,1),
        "timestamp": timestamp
    }
    elif metric == 6:
        data = {
        ...
        "zone_id" : camera_id,
        "interaction_quantity": infomation, #int
        "timestamp": timestamp
    }
