...
def send_time_to_kafka(metric, box_id, camera_id, customer_id, infomation, bootstrap_servers="hcm.gateway01.cxview.ai:9094", topic="production-boxv2-peoplecount"):
